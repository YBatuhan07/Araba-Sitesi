...
namespace ArabaSitesi.Data.Migrations
{
    ...
    [Migration("20241007203007_UserGuidEklendi")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArabaSitesi.Entities.Kullanici", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Adi = "Admin",
                            AktifMi = true,
                            EklenmeTarihi = new DateTime(2024, 10, 7, 23, 30, 7, 130, DateTimeKind.Local).AddTicks(98),
                            ...
                            Soyadi = "Admin",
                            Telefon = "553",
                            UserGuid = new Guid("55ede3d1-5c1c-4de6-9358-eba6adc0f3fa")
                        });
                });

            modelBuilder.Entity("ArabaSitesi.Entities.Marka", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArabaSitesi.Entities.Musteri", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArabaSitesi.Entities.Rol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArabaSitesi.Entities.Satis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArabaSitesi.Entities.Servis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArabaSitesi.Entities.Arac", b =>
                {
                    b.HasOne("ArabaSitesi.Entities.Marka", "Marka")
                        .WithMany()
            ...
            modelBuilder.Entity("ArabaSitesi.Entities.Kullanici", b =>
                {
                    b.HasOne("ArabaSitesi.Entities.Rol", "Rol")
                        .WithMany()
                        .HasForeignKey("RolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArabaSitesi.Entities.Musteri", b =>
                {
                    b.HasOne("ArabaSitesi.Entities.Arac", "Arac")
                        .WithMany()
            ...
            modelBuilder.Entity("ArabaSitesi.Entities.Satis", b =>
                {
                    ...
                    b.HasOne("ArabaSitesi.Entities.Musteri", "Musteri")
                        .WithMany()
